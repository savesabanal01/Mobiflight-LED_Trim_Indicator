...
2. Connect the following pins of the WS2812B to the pins of the Arduino Nano. GND pin to GND of the Nano, +5V pin to the +5V pin of the Nano, Din pin to GPIO 2 (pin 2) of the Nano
...
5. Configure an Output config in Mobiflight connector using the firmware and the appropriate trim indicator variable/dataref from MSFS or X Plane. The value of the trim indicator variable should be between -1 and 1.
